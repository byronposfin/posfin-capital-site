...
<h3 style="font-size:13px;color:#1C184F;border-bottom:2px solid #1C184F;padding-bottom:6px;margin-bottom:16px;">3. REMUNERATION (Fixed Yield)</h3>
<p style="font-size:11px;line-height:1.8;color:#333;margin-bottom:8px;"><strong>3.1 Referral Fee:</strong> The Company shall pay the Introducer a fixed fee of <strong>£1,000 (One Thousand Pounds)</strong> per completed loan case. No VAT applicable.</p>
